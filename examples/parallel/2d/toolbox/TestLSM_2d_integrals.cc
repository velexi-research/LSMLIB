/*
 * File:        TestLSM_2d_integrals.cc
 * Copyright:   (c) 2005-2006 Kevin T. Chu
 * Revision:    $Revision: 1.5 $
 * Modified:    $Date: 2006/02/18 15:52:59 $
 * Description: 2d test program for Level Set Method computing integrals
 */
...
*/
   ...
   */
  double volume_integral = LevelSetMethodToolbox<2>::computeVolumeIntegral(
    patch_hierarchy,
    velocity_handle, 
    phi_handle,
   ...
   */
  double surface_integral = LevelSetMethodToolbox<2>::computeSurfaceIntegral(
    patch_hierarchy,
    velocity_handle, 
    phi_handle,
    grad_phi_plus_handle,
