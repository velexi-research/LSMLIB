 ...
 *    to be a string value, so double quotes (") must be used; otherwise
...
public:
   ...
   *
   */
  virtual bool advanceLevelSetFunctions(const double dt);
...
protected:
  ...
  double d_start_time;                  // start time for calculation
  double d_end_time;                    // end time for calculation
  double d_cfl_number;                  // CFL number
  SPATIAL_DERIVATIVE_TYPE               // type of spatial derivative: 
  ...
  double d_reinitialization_stop_tol;   // stopping criterion for termination
                                        ...
                                        //   tolerance.
  double d_reinitialization_stop_dist;  // stopping criterion for termination
                                        //   of evolution of reinitialization 
                                        //   equation.  Reinitialization 
  ...
  double d_orthogonalization_stop_tol;  // stopping criterion for termination
                                        ...
                                        //   drops below the specified 
                                        //   tolerance.
  double d_orthogonalization_stop_dist; // stopping criterion for termination
                                        //   of evolution of orthogonalization 
                                        //   equation.  Orthogonalization 
                                        //   approximately propogates 
                                        //   information outward from the 
  ...
  int d_tag_buffer_width;               // number of buffer cells to use around
                                        //   cells tagged for refinement
  double d_refinement_cutoff_value;     // cutoff value for distance function
