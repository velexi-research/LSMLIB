 ...
 * Modified:    $Date: 2006/10/04 19:13:06 $
...
public:
   ...
   *
   *  - If this method returns any value smaller than DBL_MAX, the
   *    LevelSetFunctionIntegrator will ignore the internally computed
   ...
   * 
   */
  inline virtual double computeStableDtOnPatch(
    Patch<DIM>& patch,
