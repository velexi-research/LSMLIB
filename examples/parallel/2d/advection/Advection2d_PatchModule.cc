/*
 * File:        Advection2d_PatchModule.cc
...
extern "C" {
  #include "advection2d_patchmodule_fort.h"
}
...
// CONSTANTS
const LSMLIB_REAL Advection2d_PatchModule::s_default_radius = 0.25;

Advection2d_PatchModule::Advection2d_PatchModule(
...
void Advection2d_PatchModule::initializeLevelSetFunctionsOnPatch(
  Patch<2>& patch,
...
void Advection2d_PatchModule::setLevelSetFunctionBoundaryConditions(
    Patch<2>& patch,
...
void Advection2d_PatchModule::printClassData(ostream &os) const
{
  os << "\nAdvection2d_PatchModule::printClassData..." << endl;
  os << "Advection2d_PatchModule: this = " << (Advection2d_PatchModule*)this 
     << endl;
...
void Advection2d_PatchModule::getFromInput(
  Pointer<Database> db)
{
#ifdef DEBUG_CHECK_ASSERTIONS
  assert(!db.isNull());
  ...
  switch (d_initial_level_set) {
    ...
    default: { 
      TBOX_ERROR(  "Advection2d_PatchModule"
                << "::getFromInput()"
