/*
 * File:        Advection2d_VelocityFieldModule.cc
...
extern "C" {
  #include "advection2d_velocityfield_fort.h"
}
...
/* Constructor */
Advection2d_VelocityFieldModule::Advection2d_VelocityFieldModule(
...
void Advection2d_VelocityFieldModule::computeVelocityField(
...
/* initializeLevelData() */
void Advection2d_VelocityFieldModule::initializeLevelData (
...
void Advection2d_VelocityFieldModule::computeVelocityFieldOnLevel(
...
void Advection2d_VelocityFieldModule::printClassData(ostream& os) const
{
  os << "\nAdvection2d_VelocityFieldModule::printClassData..." << endl;
  os << "Advection2d_VelocityFieldModule: this = " << 
     (Advection2d_VelocityFieldModule*)this << endl;
...
void Advection2d_VelocityFieldModule::getFromInput(
  Pointer<Database> db)
{
#ifdef DEBUG_CHECK_ASSERTIONS
  assert(!db.isNull());
