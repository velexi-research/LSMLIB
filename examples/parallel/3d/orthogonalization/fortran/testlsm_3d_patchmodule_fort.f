c***********************************************************************
c
c  File:        testlsm_3d_patchmodule_fort.f
c  Copyright:   (c) 2005-2006 Kevin T. Chu
c  Revision:    $Revision: 1.1 $
c  Modified:    $Date: 2006/04/10 15:25:52 $
c  Description: F77 patch module routines for LSMLIB test program
c
c***********************************************************************
