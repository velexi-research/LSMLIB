 ...
 * field driven by a pressure difference and surface tension:
 *
...
public:
   ...
   * Set FieldExtensionAlgorithm.
   */
  virtual inline void setDataHandles(const int phi_handle,
...
protected:
  ...
  double d_K;      // constant relating internal pressure to bubble volume
  double d_P_ext;  // external pressure
  double d_sigma;  // surface tension

  /*
   * PatchData handles.
   */
  int d_velocity_handle; // velocity
  int d_phi_handle; // phi
  int d_grad_phi_handle; // grad(phi)
  int d_hessian_phi_handle; // Hessian of phi
  int d_kappa_handle; // mean curvature
  int d_control_volume_handle; // control volume
};
